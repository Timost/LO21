...
//void UVManager2::ajouterUV(const QString& c, const QString& t, unsigned int nbc, Categorie cat, bool a, bool p){
//    if (trouverUV(c)) {
//        throw UTProfilerException(QString("erreur, UVManager, UV ")+c+QString("déja existante"));
//    }else{
//        UV* newuv=new UV(c,t,nbc,cat,a,p);
...
//    }
//}
//UV* UVManager2::trouverUV(const QString& c)const{
//    for(unsigned int i=0; i<nbItems; i++)
//        if (c==items[i]->getCode()) return items[i];
//    return 0;
//}

//UV& UVManager2::getUV(const QString& code){
//    UV* uv=trouverUV(code);
//    if (!uv) throw UTProfilerException("erreur, UVManager, UV inexistante");
//    return *uv;
//}
...
//const UV& UVManager2::getUV(const QString& code)const{
//    return const_cast<UVManager2*>(this)->getUV(code);
//        // on peut aussi dupliquer le code de la méthode non-const
//}

///*void UVManager2::save(const QString& f){
...
//void UVManager2::load(const QString& f){
//    if (file!=f) this->~UVManager2();
//    file=f;
...
//Inscription* Dossier::InscIterator::first(){
//    index =0;
//    return current();
//}
//Inscription* Dossier::InscIterator::next (){
//    index++;
//    return current();
//}
//Inscription* Dossier::InscIterator::current (){
//    return inscri[index];
//}

//bool Dossier::InscIterator::isDone(){return index+1==nbMax;}*/
